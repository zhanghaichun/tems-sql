...
BEGIN
  ...
  IF( V_VENDOR_NAME != V_ORIGIN_VENDOR_NAME AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;
  ...
  IF( V_ITEM_TYPE != V_ORIGIN_ITEM_TYPE AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;
  ...
  IF( V_QUANTITY_BEGIN != V_ORIGIN_QUANTITY_BEGIN AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_QUANTITY_END != V_ORIGIN_QUANTITY_END AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_TARIFF_FILE_NAME != V_ORIGIN_TARIFF_FILE_NAME AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_TARIFF_NAME != V_ORIGIN_TARIFF_NAME AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_BASE_AMOUNT != V_ORIGIN_BASE_AMOUNT AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_MULTIPLIER != V_ORIGIN_MULTIPLIER AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;
  ...
  IF( V_RULES_DETAILS != V_ORIGIN_RULES_DETAILS AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_TARIFF_PAGE != V_ORIGIN_TARIFF_PAGE AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_PART_SECTION!= V_ORIGIN_PART_SECTION AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_ITEM_NUMBER != V_ORIGIN_ITEM_NUMBER AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_CRTC_NUMBER != V_ORIGIN_CRTC_NUMBER AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;
  ...
  IF( V_EXCLUSION_BAN != V_ORIGIN_EXCUSION_BAN AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;

  IF( V_EXCLUSION_ITEM_DESCRIPTION != V_ORIGIN_EXCLUSION_ITEM_DESCRIPTION AND V_UPDATED_FLAG = FALSE ) THEN
    SET V_UPDATED_FLAG = TRUE;
  END IF;
