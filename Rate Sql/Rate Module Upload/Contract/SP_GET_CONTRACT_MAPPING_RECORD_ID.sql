DROP PROCEDURE IF EXISTS SP_GET_CONTRACT_MAPPING_RECORD_ID;
CREATE PROCEDURE SP_GET_CONTRACT_MAPPING_RECORD_ID(
...
BEGIN 
  ...
  /**
   * 查询在 audit_reference_mapping 表中是否有匹配的 contract 记录。
   */
  ...
  DECLARE CONST_CVPP_KEY VARCHAR(64) DEFAULT 'cvpp';
